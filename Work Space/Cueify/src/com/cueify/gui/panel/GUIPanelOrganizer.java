...
public class GUIPanelOrganizer<ModelType, ViewType extends Node> {
	...
	public GUIPanelOrganizer(ViewType rootToSetUp, URL fxmlURL, ModelType ref, ViewModelDeleget<ModelType, ViewType> vmd) {
		launch(rootToSetUp, fxmlURL, ref, vmd);
	}
	 ...
	 */
	public void launch(ViewType rootToSetUp, URL fxmlURL,  ModelType ref, ViewModelDeleget<ModelType, ViewType> vmd) {
		launch(rootToSetUp, fxmlURL, ref, vmd, null);
	}
	
	public void launch(ViewType rootToSetUp, URL fxmlURL, ModelType ref, ViewModelDeleget<ModelType, ViewType> vmd,  GUIViewCallback callback) {
