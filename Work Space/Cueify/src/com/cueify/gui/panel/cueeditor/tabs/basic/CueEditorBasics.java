...
public class CueEditorBasics extends GridPane implements TabGUI, GUIViewCallback, ViewModelDeleget<CueEditorModel, CueEditorBasics> {
	@FXML
	...
	public CueEditorBasics(CueEditorModel ref) {
		new GUIPanelOrganizer<CueEditorModel, CueEditorBasics>(this, FXML_LOCATION, ref, this);
	}
	...
	@Override
	public GUIViewModel<CueEditorModel, CueEditorBasics> createViewModel() {
